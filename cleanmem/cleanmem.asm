...
MemLoop:
	...
	bne MemLoop		; Loop until X is equal to zero (z-flag is set)
					; Literally: Branch to label 'MemLoop' if X is not equal to zero.
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	...
	org $FFFC
	.word Start		; Reset vector tat $FFFC (where the program starts)
	.word Start		; Interrupt vector at $FFFE (required for 650 but unused in the VCS